...
function contextCopy(scenario: ScenarioTag): Pick<ConversationResponse, "empathy" | "praise" | "tinyAction"> {
  const copy: Record<ScenarioTag, Pick<ConversationResponse, "empathy" | "praise" | "tinyAction">> = {
    customer_conflict: {
