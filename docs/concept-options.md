# Concept Options: 醫護樹洞

## Decision Summary

「醫護樹洞」可以做成 LINE Bot、Web App、舒壓小遊戲，或混合型產品。若目標是最快讓醫護人員用起來，LINE Bot 最快；若目標是驗收時有完整視覺與產品感，Web App 最好；若目標是做出療癒記憶點，遊戲化空間最好。
...
原因：Web App 最適合展示「醫護樹洞」完整世界觀、情緒功能、收藏、點歌、抽牌與療癒互動；LINE Bot 再作為日常短入口；遊戲化則作為留存與品牌特色，不一開始壓到核心開發。
...
一個低壓、無輸贏的療癒小遊戲。玩家是下班後的醫護人員，走進一個小樹洞，把今天的壓力變成可放下的葉子、星光或紙袋。每次完成一個舒壓互動，小樹會長出一點點新的枝葉。
...
遊戲化只做低壓、無排名、無任務壓力的「小樹成長」。不要做會讓醫護人員覺得又多一個責任的打卡系統。
