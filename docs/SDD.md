...
「藥師樹洞」是一個給藥師使用的舒壓與心理健康支持服務。產品文案與互動聚焦社區藥局、醫院藥師與 PGY 藥師情境。第一版建議以 Web App 為主要入口，讓使用者用一句話丟出工作壓力、委屈、疲憊或迷惘，系統回覆具體同理、誇誇、小型行動建議，並可延伸到金句、書摘、心情點歌與娛樂型塔羅。

LINE Bot 作為第二入口，用於日常短回合互動。Web App 承擔完整驗收體驗，例如樹洞主畫面、日記回顧、偏好設定、內容庫管理、匿名資料洞察與後台測試。

## 2. Goals

- 讓藥師在工作空檔用 Web App 或 LINE 快速得到情緒支持。
- 產生貼近藥師場景的誇誇與療癒回覆。
- 提供不具診斷性的心情整理工具。
...
- 社區藥局藥師：面對民眾溝通、處方疑義、慢箋、庫存與客訴壓力。
- 醫院藥師：面對處方審核、交互作用、缺藥、管制品項、交班與跨團隊溝通壓力。
- PGY 藥師：面對學習壓力、考核、職涯不確定與自我懷疑。

使用情境：

- 剛被病人、民眾或家屬兇完。
- 上班太忙沒有時間好好消化情緒。
- 給藥、處方、交班、紀錄或用藥安全細節確認壓力很大。
- 下班後想被誇一下。
