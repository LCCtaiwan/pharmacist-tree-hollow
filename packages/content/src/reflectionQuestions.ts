import type { ReflectionQuestion } from "@pharmacist-tree-hollow/shared";

export const reflectionQuestions: ReflectionQuestion[] = [
  // today — 回看今天的細節（10 題）
  { id: "today-001", category: "today", text: "今天有沒有一個瞬間，你被自己的細心救了？" },
  { id: "today-002", category: "today", text: "你今天替誰把關了？這件事讓你變得怎樣？" },
  { id: "today-003", category: "today", text: "最近有什麼事，雖然你沒做但其實沒人發現會很慘？" },
  { id: "today-004", category: "today", text: "今天有沒有一句話，你忍住沒回？" },
  { id: "today-005", category: "today", text: "下班那一刻，你最想立刻放下哪一件事？" },
  { id: "today-006", category: "today", text: "今天哪一個動作做了很多次，你卻沒讓它出錯？" },
  { id: "today-007", category: "today", text: "今天有沒有一段時間，你其實沒空喝水？" },
  { id: "today-008", category: "today", text: "今天最累的不是事情，是哪一種感覺？" },
  ...
  { id: "self-004", category: "self", text: "上一次你「只是坐著」，是什麼時候？" },
  { id: "self-005", category: "self", text: "如果今晚可以只做一件對自己好的事，會是什麼？" },
  { id: "self-006", category: "self", text: "如果脫下這身工作的角色，今晚的你最想要什麼？" },
  { id: "self-007", category: "self", text: "你今天有沒有給自己留下哪怕五分鐘？" },
  { id: "self-008", category: "self", text: "最近有沒有一首歌、一句話、或一個人，讓你比較像自己？" },
  { id: "self-009", category: "self", text: "如果今晚有人問你「你還好嗎」，你想怎麼回？" },
  { id: "self-010", category: "self", text: "今晚最想關掉的，是哪一種聲音？" },
];
