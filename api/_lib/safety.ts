import type { RiskLevel } from "@pharmacist-tree-hollow/shared";
...
export function classifyApiSafety(input: string): Exclude<RiskLevel, "normal"> | "normal" {
  ...
  if (medicalBoundaryPatterns.some((pattern) => pattern.test(normalized))) {
